...
public class AppratusPersonal611 extends baseIncident {
	public AppratusPersonal611()
	{
	...
	public void apppersonalselect(String Appname, String personname, String Remark) throws Exception {
		 ...
		 * click(ArrivalDate,"Arrival Date"); click(OKbutn,"OK Button");
		 * click(ArrivalTime,"Arrival Time"); click(OKbutn,"OK Button");
		 */
