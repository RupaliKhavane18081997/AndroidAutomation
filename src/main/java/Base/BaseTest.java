...
public class BaseTest {
	...
	public void configBc(ITestContext context) throws Throwable {
		...
		//pdf = new ExtentPDFReporter("./Extent Report/" +dateForReport()+"/"+ className + "/" + className+ dateTime() +".pdf");
	...
	public static void getScreenshot1(String s) throws IOException {
	...
	public void configAm(ITestResult result) throws Exception {
		...
		if (result.getStatus() == ITestResult.FAILURE) {
			test.log(Status.FAIL, result.getMethod().getMethodName(), MediaEntityBuilder
					.createScreenCaptureFromPath(ReporterClass.getScreenshot())
					.build());
			report.flush();
...
//		driver.quit();
		...
		//convertHtmlToPdf("./Extent Report/" +dateForReport()+"/"+ className + "/" + className+ dateTime() +".html", "./Extent Report/" +dateForReport()+"/"+ className + "/" + className+ dateTime() +".pdf");;
	}
...
//			driver.activateApp("com.android.chrome");
	...
	private static void convertHtmlToPdf(String htmlContent, String pdfFilePath) {
        try {
