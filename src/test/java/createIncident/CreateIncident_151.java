...
public class CreateIncident_151 extends BaseTest {
	baseIncident createIncident;
	String testCaseName = "CreateIncident_151";
	...
	public void TestCase10Arson(Hashtable<String, String> data) throws Exception {
		...
		Arson.ArsonDetails();
		VerificationUtils.validate("true", Arson.verifySuccessfulMessage(), "Success incident Created");
