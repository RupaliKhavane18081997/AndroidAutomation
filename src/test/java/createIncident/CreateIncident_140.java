...
public class CreateIncident_140 extends BaseTest {
	baseIncident createIncident;
	String testCaseName = "CreateIncident_140";
	...
	public void TestCase04Fire(Hashtable<String, String> data) throws Exception {
		...
		// D_Ignition
		/*
		 * D_Ignition D_Ignition = new D_Ignition(); D_Ignition.D_Igni();
		 */
		D_IgnitionNew D_IgnitionNew = new D_IgnitionNew();
		D_IgnitionNew.D_IgnitionNewFirstItem();
		createIncident.nextbutton();
	...
	public void TestCase05StructureFire(Hashtable<String, String> data) throws Exception {
		/*
		 * //Structure Started //l1StrutureType Structuretype Structuretype = new
		 * Structuretype(); Structuretype.Structype(data.get("StructureType"));
		 * createIncident.nextbutton();
		 * 
		 * 
		 * 
		 * //Building Status I2_BuildingStatus I2_BuildingStatus= new
		 * I2_BuildingStatus();
		 ...
		 * 
		 * 
		 * //Building height buildingHeight buildingHeight = new buildingHeight();
		 * buildingHeight.building(data.get("BuildingHeightAboveGrade"),
		 * data.get("BuildingHeightBelowGrade")); createIncident.nextbutton();
		 * 
		 * // L4 Main Floor Size l4mainfloorsize l4mainfloorsize = new
		 * l4mainfloorsize(); l4mainfloorsize.mainfloor(data.get("TotalSquareFeet"));
		 * createIncident.nextbutton(); // j1 FireOrgin j1fireorigin j1fireorigin = new
		 * j1fireorigin(); j1fireorigin.origin(data.get("StoryofFireOrigin"));
		 * createIncident.nextbutton(); //j2 Fire Spread j2firespread j2firespread = new
		 * j2firespread(); j2firespread.firespread(data.get("FireSpread"));
		 * createIncident.nextbutton(); //j3 Fire Spread createIncident.nextbutton(); //
		 * k type of material contributing Most of flame spread?
		 * createIncident.nextbutton(); // L1 Present of Detectors l1presentdetectors
		 * l1presentdetectors = new l1presentdetectors();
		 * l1presentdetectors.detectorspres(); createIncident.nextbutton(); // l2 dec
		 * type l2dectortype l2dectortype = new l2dectortype();
		 * l2dectortype.detectorspres(); createIncident.nextbutton(); // l3 Dectors
		 * Power Suply l3dectorspowersupply l3dectorspowersupply = new
		 * l3dectorspowersupply(); l3dectorspowersupply.powersuppky();
		 * createIncident.nextbutton(); //l4 detectors l4DetectorOperation
		 * l4DetectorOperation = new l4DetectorOperation();
		 * l4DetectorOperation.detectorops(); createIncident.nextbutton(); //M1 Presence
		 * of Automatic Extinguishing System m1presenceofautomaticsystems
		 * m1presenceofautomaticsystems = new m1presenceofautomaticsystems();
		 * m1presenceofautomaticsystems.systems(); createIncident.nextbutton(); // m2
		 * createIncident.nextbutton(); // m3 createIncident.nextbutton(); // m4
		 * createIncident.nextbutton(); // m5 createIncident.nextbutton();
		 * 
		 * 
		 * createIncident.nextbutton(); createIncident.nextbutton(); // structure
		 * Complete
		 */ }
	...
	public void TestCase06Civillian_FireCasualty(Hashtable<String, String> data) throws Exception {
		...
		Civillian_FireCasualty.CivillianFireCasualty(data.get("CivilianDeath"), data.get("CivilianInjuries"),
				data.get("VictimFirstName"), data.get("VictimLastName"), data.get("Age"), data.get("Severity"));
		createIncident.nextbutton();
		createIncident.nextbutton();
		try {
			createIncident.nextbutton();
	...
	public void TestCase08EMS(Hashtable<String, String> data) throws Exception {
		...
		EMS EMS = new EMS();
		EMS.EMStatus(data.get("ProviderImpAss"), data.get("ProUsed"), data.get("initialArrestRhythm"),
				data.get("IntLevelOfProvider"));
		createIncident.nextbutton();
		createIncident.nextbutton();
	...
	@Test(dataProvider = "getData")
	public void TestCase09WildLand(Hashtable<String, String> data) throws Exception {
		// EMS

		WildLandModule WildLandModule = new WildLandModule();
		WildLandModule.WildLandModuleDetails(data.get("WildLandAreaType"), data.get("WildLandFireCause"), data.get("WildLandHumanFactorContributingIgnition"),
				data.get("FactorsContributingToIgnition"),data.get("FireSupressionFactor"));
		createIncident.nextbutton();
		createIncident.nextbutton();
	...
	@Test(dataProvider = "getData")
	public void TestCase10HazMAt(Hashtable<String, String> data) throws Exception {
	...
	@Test(dataProvider = "getData")
	public void TestCase11Arson(Hashtable<String, String> data) throws Exception {
		// Arson
