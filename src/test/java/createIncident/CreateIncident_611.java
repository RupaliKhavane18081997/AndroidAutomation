...
public class CreateIncident_611 extends BaseTest {
	baseIncident createIncident;
	String testCaseName = "CreateIncident_611";
	...
	public void TestCase03ApparatusAndPersonnal(Hashtable<String, String> data) throws Exception {
		...
		// mauthorize
		M_Authorization611 M_Authorization611 = new M_Authorization611();
		M_Authorization611.M_Authorization611Details();
		createIncident.nextbutton();
		// Basic end
		// Appratus
		AppratusPersonal611 AppratusPersonal611 = new AppratusPersonal611();
		AppratusPersonal611.apppersonalselect(data.get("ApparatusName"), data.get("Personnel"),
