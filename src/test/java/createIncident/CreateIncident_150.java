...
public class CreateIncident_150 extends BaseTest {
	baseIncident createIncident;
	String testCaseName = "CreateIncident_150";
	...
	public void TestCase10Arson(Hashtable<String, String> data) throws Exception {
		...
		Arson.ArsonDetails();
		VerificationUtils.validate("true", Arson.verifySuccessfulMessage(), "Successfully incident Created");
