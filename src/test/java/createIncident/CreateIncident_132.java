...
public class CreateIncident_132 extends BaseTest {
	baseIncident createIncident;
	String testCaseName = "CreateIncident_132";
	...
	public void TestCase04Fire(Hashtable<String, String> data) throws Exception {
		...
		/*
		 * // D_Ignition D_Ignition D_Ignition = new D_Ignition();
		 * D_Ignition.D_Igni(data.get("ItemFirstIgnited"),
		 * data.get("TypeofMaterialFirstIgnited")); createIncident.nextbutton();
		 */
	...
	public void TestCase05StructureFire(Hashtable<String, String> data) throws Exception {
		 ...
		 * 
		 * 
		 * createIncident.nextbutton(); // structure Complete
		 */ }
